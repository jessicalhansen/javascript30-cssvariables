...
export default function App() {
  ...
  const [base, setBase] = useState("#bada55");
  ...
  return (
    <div style={{ "--spacing": `${spacing}px`, "--blur": `${blur}px`, "--base": `${base}` }}>
      <h2>
      ...
      <div className="controls">
        ...
        <input id="base" type="color" name="base" value={base} onChange={onChangeBase} />
      </div>
